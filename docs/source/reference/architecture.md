...
**Learn more:** See [Authentication](../user/authentication.md) for details on the user login and approval process, and [Authentication Reference](authentication.md) for the mechanics behind it.
