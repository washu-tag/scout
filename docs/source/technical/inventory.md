...
**Layer 2 (structured variables):** Use `coredns_forward_domains` and `coredns_host_domains` for common DNS patterns:
...
# Domains to resolve via /etc/coredns/NodeHosts (K3s-managed hosts file)
