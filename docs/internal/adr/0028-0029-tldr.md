# TL;DR — Versioning & GitOps Deployment (ADRs 0028 + 0029)

One-page orientation for [ADR 0028](0028-two-lane-versioning-and-artifact-publishing.md)
(versioning and artifact publishing) and
[ADR 0029](0029-gitops-deployment-base.md) (GitOps deployment base). The
...
**ADR 0028 — versioning.** Every merge to `main` that changes something
...
**ADR 0029 — deployment.** Scout ships its deployment as a Kustomize base
