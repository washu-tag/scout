...
- **0033** Hauler build lane — the build manifest is a signed Hauler haul, mirrored to Harbor via `hauler store copy`. Read before changing build-lane bundling or air-gap transport
