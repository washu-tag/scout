...
- **0033** Hauler build lane — the build manifest is a signed Hauler haul; `hauler store copy` mirrors it into Harbor for air-gapped sites (refines 0030/0031). Read before changing build-lane bundling, signing, or air-gap transport
