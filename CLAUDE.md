...
- **0037** keycloak realm single writer — only `app-manager` applies the realm; a deploy publishes the base realm document and stops, and components ship their own clients as fragments. Read before touching realm apply or fragment discovery
