...
/**
 * Maps a normalized {@link ScoutIdentity} to an XNAT {@link UserI}, creating the
 * XNAT user on first sight. Encodes the {@code keycloak-<sub>} username pattern
 * carried over from the previous POC so existing dev03 users stay re-usable if
 * we choose to keep them.
 *
 * Role gate: rejects with 403 unless the identity carries the configured
...
public class UserProvisioningService {
    ...
    public UserProvisioningService(final XdatUserAuthService userAuthService,
