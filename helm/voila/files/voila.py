...
Importing scout.voila triggers the TornadoVoilaHandler monkey-patch at
...
import scout.voila  # noqa: F401 - monkey-patches TornadoVoilaHandler on import

c.VoilaConfiguration.multi_kernel_manager_class = (
    "scout.voila.ScoutMappingKernelManager"  # noqa: F821
)
