...
| `observation_dt` | timestamp | Study date/time |
...
```sql
SELECT epic_mrn, patient_age, service_name, observation_dt, report_section_impression
FROM reports
WHERE modality = 'CT'
...
3. **Present results clearly** - don't show SQL unless asked
4. **Suggest follow-ups** - offer related analyses
...
Docs: https://washu-scout.readthedocs.io/en/latest/dataschema.html
