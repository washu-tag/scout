...
Install a filter to handle long conversations that approach the 128K context window limit. Without this filter, Ollama silently truncates older messages, causing conversations to "fall apart." See [ADR 0011](../../../docs/internal/adr/0011-open-webui-context-summarization-filter.md) for details.
...
- **ADRs**:
  ...
  - [ADR 0011: Context Summarization Filter](../../../docs/internal/adr/0011-open-webui-context-summarization-filter.md)
