...
class JsonFormatter(logging.Formatter):
    ...
    caller passed via `logger.info("msg", extra={"dataset_id": ...})`.
    """
    ...
    def format(self, record: logging.LogRecord) -> str:  # noqa: A003
        ...
        # level key (e.g. dataset_id, user_sub, request_id, duration_ms).
...
def configure(level: str = "INFO") -> None:
    ...
    Honors `DATASETS_LOG_LEVEL` if set; otherwise uses the passed level.
    """
    effective_level = os.environ.get("DATASETS_LOG_LEVEL", level).upper()
